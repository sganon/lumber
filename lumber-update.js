...
program
  ...
  .option('-t, --typescript', 'Use if your project was converted to typescript')
  .parse(process.argv);
...
(async () => {
  ...
  config.typescript = program.opts().typescript
  if (config.typescript) {
    config.sourceDirectory = path.join(config.sourceDirectory, 'src')
  }
